...
def plot_basic(stocks, title='Nabil Trading', y_label='Price NRS', x_label='Trading Days'):
    """
    Plots basic pyplot
...
def plot_prediction(actual, prediction, title='Nabil Trading vs Prediction', y_label='Price NRS', x_label='Trading Days'):
    """
...
def plot_lstm_prediction(actual, prediction, title='Nabil Trading vs Prediction', y_label='Price NRS', x_label='Trading Days'):
    """
    Plots train, test and prediction
    :param actual: DataFrame containing actual data
    :param prediction: DataFrame containing predicted values
